    ...
    renderAccountCreated() {
        ...
        return <div class={style.signup}>
            <Paper class={style.signedUp}>
                ...
                <Divider/>
                <p>You created an account named <em>{username}</em>. Remember never to share your password with anyone :
                    we will never
            ...
            <div class={style.signup}>
                <form onSubmit={this.submit}>
                    <Paper class={style.signupForm}>
                        ...
                        <TextField style={{width: '100%'}} name="username" hintText="John Doe."
                                   onChange={this.setUsername}
                                   value={username}/>

                        <TextField style={{width: '100%'}} name="password" hintText="Strong password"
